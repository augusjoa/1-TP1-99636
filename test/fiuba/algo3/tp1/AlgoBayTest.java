...
public class AlgoBayTest {
	...
	@Test
   	public void testAgregarProductos() {
        ...
        Producto picodulce = algoBay.agregarProductoConPrecio("Pico dulce", 10);
        
        Assert.assertEquals(2, algoBay.getCantidadDeProductos());

        Assert.assertNotNull(spinner);
        
        Assert.assertNotNull(picodulce);
    }
	    ...
	    public void testObtenerProducto() {
	        ...
	        algoBay.agregarProductoConPrecio("Moto G", 4399);

	        Producto motorola = algoBay.getProducto("Moto G");

	        Assert.assertNotNull(motorola);
	    }

	    @Test
	    public void testCrearCompraSimple() {
	    ...
	    public void testCrearCupon() {
	    	...
	    	Cupon cupon = algoBay.crearCuponConPorcentaje(10);
	    ...
	    @Test
	    public void testgetPrecioTotalDeCompra() {

	        AlgoBay algoBay = new AlgoBay();

	        Producto remera = algoBay.agregarProductoConPrecio("Remera Wookie", 700);

	        Compra compra = algoBay.crearNuevaCompra();
	        algoBay.agregarProductoEnCompra(remera, compra);
